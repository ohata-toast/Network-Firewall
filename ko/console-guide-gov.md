...
>* 단일 또는 이중화 구성을 선택하여 Network Firewall을 생성한 후 구성변경 필요시 **옵션** 탭에서 구성을 변경할 수 있습니다.
...
> [삭제시 주의사항]
> 
> * 운영중인 Network Firewall을 삭제할 경우 Network Firewall과 연결된 다른 서비스를 고려해서 삭제를 진행 해주세요.
...
> 예를 들어 동일한 프로젝트의 판교 리전과 평촌 리전에 모두 Network Firewall 서비스를 활성화한 경우 두 리전 중 하나의 Network Firewall 서비스만 비활성화할 수 없습니다.
> * 비활성화를 하려면 판교 리전과 평촌 리전에서 각각 Network Firewall을 삭제한 후 비활성화를 해주세요.