...
* 인터넷 환경에서 사이트간 암호화된 터널을 통해 안전한 가상 사설 네트워크(VPN)를 제공 합니다.    
...
> 예를 들어, 개선하기 전의 네트워크 환경을 사용하는 프로젝트와 신규 네트워크 환경을 사용하는 프로젝트가 생성되어 있을 경우 신규 네트워크 환경에 Network Firewall을 생성할 수 있지만 개선하기 전의 네트워크 환경을 Spoke VPC로 사용할 수 없습니다.
